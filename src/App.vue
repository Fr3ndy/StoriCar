...
<template>
  <div class="app">
    ...
    <div v-if="isShell" class="beta-banner">
      ...
      <span><strong>Beta</strong> — I dati potrebbero subire variazioni senza preavviso.</span>
    </div>
    ...
    <Transition name="drawer">
      <div v-if="menuOpen" class="drawer">
        <div class="drawer-header">
          ...
          <button class="btn-icon" @click="closeMenu" style="background:var(--bg-secondary)">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="drawer-body">
          ...
          <div class="drawer-footer">
            ...
            <button class="btn btn-sm btn-secondary" style="color:var(--danger);border-color:rgba(239,68,68,0.3)" @click="handleSignOut">
...
.beta-banner svg { width: 13px; height: 13px; flex-shrink: 0; color: #d97706; }
[data-theme="dark"] .beta-banner { background: #1c1208; border-color: #78350f; color: #fcd34d; }
...
.overlay-enter-active, .overlay-leave-active { transition: opacity .22s ease; }
...
@media (min-width: 600px) {
  ...
  .drawer-enter-active, .drawer-leave-active { transition: opacity .18s ease, transform .18s ease; }
  .drawer-enter-from, .drawer-leave-to { opacity: 0; transform: translate(-50%, -48%); }
...
.drawer-item.active .drawer-item-label { color: var(--primary); font-weight: 700; }
.drawer-item.active .drawer-icon { background: var(--primary) !important; color: white !important; }
...
.drawer-chevron { width: 15px; height: 15px; color: var(--text-secondary); flex-shrink: 0; }
